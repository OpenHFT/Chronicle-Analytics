...
image:https://img.shields.io/hexpm/l/plug.svg?maxAge=2592000[License, link=https://raw.githubusercontent.com/net.openhft/chronicle-analytics/master/LICENSE]
