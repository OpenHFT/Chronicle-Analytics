...
Applications will create and use instances of "Analytics". Analytic instances are created using a builder pattern that allow various custom parameters to be set:
