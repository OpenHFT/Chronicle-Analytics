...
This library provides remote ingress to Google Analytics 4, allowing data, such as usage statistics, to be collected for Java applications.
The data can subsequently be analysed using a variety of tools available from Google and other providers.
...
This JAR is redundant but can help ensure this library is effectively disabled.
