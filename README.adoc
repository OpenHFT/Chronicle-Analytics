...
image:https://img.shields.io/maven-central/v/net.openhft/chronicle-analytics.svg[Maven Central,link=https://central.sonatype.com/artifact/net.openhft/chronicle-analytics]
