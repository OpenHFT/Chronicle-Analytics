...
image:https://javadoc-badge.appspot.com/net.openhft/chronicle-analytics.svg?label=javadoc[JavaDoc, https://www.javadoc.io/doc/net.openhft/chronicle-analytics]
image:https://img.shields.io/hexpm/l/plug.svg?maxAge=2592000[License, https://raw.githubusercontent.com/speedment/speedment/master/LICENSE]
...
Configuration of the builder includes the following:
...
NOTE: All parameters and returns values are non-null.

NOTE: See the link:https://www.javadoc.io/doc/net.openhft/chronicle-analytics[JavaDocs] for more details on the methods above.
